...
class SpinSpinningLines extends StatefulWidget {
  const SpinSpinningLines({
    Key? key,
    required this.color,
    this.size = 70,
    this.lineWidth = 2.0,
  ...
  @override
  State<SpinSpinningLines> createState() => _SpinSpinningLinesState();
}

class _SpinSpinningLinesState extends State<SpinSpinningLines> with SingleTickerProviderStateMixin {
...
class SpinningLinesPainter extends CustomPainter {
  ...
  double _getRadian(double angle) => pi / 180 * angle;
