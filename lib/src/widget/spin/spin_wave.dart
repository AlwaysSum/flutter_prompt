...
class SpinWaveSpinner extends StatefulWidget {
  const SpinWaveSpinner({
    Key? key,
    required this.color,
  ...
  @override
  State<SpinWaveSpinner> createState() => _SpinWaveSpinnerState();
}

class _SpinWaveSpinnerState extends State<SpinWaveSpinner> with SingleTickerProviderStateMixin {
